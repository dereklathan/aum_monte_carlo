...
void sim_actions::add_timestep(Cube cube, list<Atom> atomlist){
	...
	while(!sim_actions::all_attempted(atomlist)){
		...
		if(rand_axis==0 && !(it->get_attempted())){
			...
			if(rand_dir==1 && it->get_x_pos()==0 && !cube.get_occupy_space(cube.get_domain_x()-1, it->get_y_pos(), it->get_z_pos()))
			{
				cube.set_occupy_space(it->get_x_pos(), it->get_y_pos(), it->get_z_pos(), false);
			...
			if(rand_dir==1 && it->get_y_pos()==0 && !cube.get_occupy_space(it->get_x_pos(), cube.get_domain_y()-1, it->get_z_pos()))
			{
				cube.set_occupy_space(it->get_x_pos(), it->get_y_pos(), it->get_z_pos(), false);
			...
			if(rand_dir==1 && it->get_z_pos()==0 && !cube.get_occupy_space(it->get_x_pos(), it->get_y_pos(), cube.get_domain_z()-1))
			{
				cube.set_occupy_space(it->get_x_pos(), it->get_y_pos(), it->get_z_pos(), false);
